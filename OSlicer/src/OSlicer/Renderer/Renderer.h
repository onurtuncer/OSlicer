...
#include "OSlicer/Core/RenderThread.h"
...
namespace Hazel {
	...
	namespace Utils {
		...
		inline void DumpGPUInfo()
		{
			...
			OS_CORE_TRACE_TAG("Renderer", "GPU Info:");
			OS_CORE_TRACE_TAG("Renderer", "  Vendor: {0}", caps.Vendor);
			OS_CORE_TRACE_TAG("Renderer", "  Device: {0}", caps.Device);
			OS_CORE_TRACE_TAG("Renderer", "  Version: {0}", caps.Version);
		}
