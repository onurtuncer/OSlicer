...
namespace OSlicer::Utils {
	...
	inline void VulkanCheckResult(VkResult result, const char* file, int line)
	{
		if (result != VK_SUCCESS)
		{
			...
			OS_CORE_ASSERT(result == VK_SUCCESS);
		}
	}
}
...
{\
	VkResult res = (f);\
	::OSlicer::Utils::VulkanCheckResult(res, __FILE__, __LINE__);\
}

namespace OSlicer::VKUtils
{
