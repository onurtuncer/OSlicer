...
#include "OSlicer/Renderer/UI/Font.h"

#include <GLFW/glfw3.h>
#include <imgui/imgui.h>
#include "OSlicer/ImGui/Colors.h"
#include "OSlicer/Asset/AssetManager.h"
#include "Input.h"

#include "OSlicer/Platform/Vulkan/VulkanRenderer.h"
#include "OSlicer/Platform/Vulkan/VulkanAllocator.h"
#include "OSlicer/Platform/Vulkan/VulkanSwapChain.h"
#include "imgui/imgui_internal.h"

#include "OSlicer/Utilities/StringUtils.h"
#include "OSlicer/Debug/Profiler.h"
#include "OSlicer/Editor/EditorApplicationSettings.h"
#include <filesystem>
#include <nfd.hpp>
#include "Memory.h"
...
#define BIND_EVENT_FN(fn) std::bind(&Application::##fn, this, std::placeholders::_1)
		...
		: m_Specification(specification), m_RenderThread(specification.CoreThreadingPolicy), m_AppSettings("App.hsettings")
	{
		...
		OS_CORE_VERIFY(NFD::Init() == NFD_OKAY);
...
#if defined(OS_DEBUG)
		return "Debug";
#elif defined(OS_RELEASE)
		return "Release";
#elif defined(OS_DIST)
		return "Dist";
#else
