...
#include "OSlicer/Renderer/RendererAPI.h"

#include "OSlicer/Platform/Vulkan/VulkanContext.h"
...
#include "OSlicer/Embed/HazelIcon.embed"

	static void GLFWErrorCallback(int error, const char* description)
	{
		OS_CORE_ERROR_TAG("GLFW", "GLFW Error ({0}): {1}", error, description);
	}
	...
	void Window::Init()
	{
		...
		OS_CORE_INFO_TAG("GLFW", "Creating window {0} ({1}, {2})", m_Specification.Title, m_Specification.Width, m_Specification.Height);
